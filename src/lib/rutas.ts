...
// Medallas de personaje (bloque Y): índice del progreso hacia cada medalla,
// no solo su reflejo en la casilla del álbum.
export function rutaMedallas(materiaSlug: string): string {
